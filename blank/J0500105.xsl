...
<html><head>
<TITLE>- J0500105 - "Податковий розрахунок сум доходу, нарахованого (сплаченого) на користь платників податку, і сум утриманого з них податку"</TITLE>
...
<TABLE width="100%" border="0" cellspacing="4">
  <TR>
	...
	<TR>
		<TD width="5%" class="td_box" align="center"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></TD>
...
<table width="100%" border="0" cellspacing="4">
  <tr>
    <td width="20%" >Керівник юридичної особи</td>
