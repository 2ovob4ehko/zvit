<div id="page">
  <div class="blank">
    <table>
      <tr>
        ...
        <td><button onclick="saveDocuments('F0103304')">Зберегти</button></td>
      </tr>
    </table>
  ...
  <table class="bordered">
    ...
    <tr>
      <td colspan="2">
  		    <input class="filling" type="text" style="width:100%;" name="HNAME" value="<? echo $f->name; ?>">
      </td>
  	</tr>
    <tr>
      <td>Реєстраційний номер облікової картки платника податків - фізичної особи - підприємця:</td>
  		<td>
        <input class="filling" type="text" style="width:100%;" name="HTIN" value="<? echo $f->tin; ?>">
      </td>
  	</tr>
  	<tr>
  ...
  <table class="bordered">
      ...
      <td colspan="3">Податкова адреса (місце проживання) платника податку</td>
  		...
  		<td><input class="filling" type="text" style="width:100%;" name="HZIP" value="<? echo $f->zipcode; ?>"></td>
    </tr>
  	<tr>
  		<td>(область, місто):</td>
  		<td><input class="filling" type="text" style="width:100%;" name="HREG" value="<? echo $f->state; ?>"></td>
  		<td><input class="filling" type="text" style="width:100%;" name="HCITY" value="<? echo $f->city; ?>"></td>
  		<td>міжміський код</td>
  		<td><input class="filling" type="text" style="width:100%;" name="HINTURB" value="<? echo $f->telcode; ?>"></td>
  	</tr>
  	<tr>
  		<td>Адреса:</td>
  		<td colspan="2"><input class="filling" type="text" style="width:100%;" name="HLOC" value="<? echo $f->address; ?>"></td>
  		<td>телефон</td>
  		<td><input class="filling" type="text" style="width:100%;" name="HTEL" value="<? echo $f->tel; ?>"></td>
  	</tr>
  	<tr>
  		<td>Електронна адреса:</td>
  		<td colspan="2"><input class="filling" type="text" style="width:100%;" name="HEMAIL" value="<? echo $f->email; ?>"></td>
  		<td>факс:</td>
  		<td><input class="filling" type="text" style="width:100%;" name="HFAX" value="<? echo $f->fax; ?>"></td>
  	</tr>
  </table>
  <table class="bordered">
    <tr>
  ...
  <table class="bordered">
    <tr>
      <td>Фактична чисельність найманих працівників у  звітному  періоді:</td>
  		<td><input class="filling" type="text" style="width:100%;" name="HNACTL" value=""></td>
  	</tr>
  </table>
  ...
  <table>
    <tr>
      ...
      <td><input class="filling" type="text" style="width:250px;" name="HBOS" value="<? echo $f->bfio; ?>"></td>
  		<td><input class="filling" type="text" style="width:100px;" name="HKBOS" value="<? echo $f->btin; ?>"></td>
    </tr>
    <tr>
      <td></td>
